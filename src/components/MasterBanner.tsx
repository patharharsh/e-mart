  ...
  return (
    <div className="w-full rounded-lg overflow-hidden relative">
      <div className=" absolute z-1 top-[20%] left-10 ">
        <h1 className="text-[72px] leading-[120%] font-semibold w-2/3 text-white ">Fresh & Healthy Organic Food</h1>
        <div className="border-l-2 py-2 pl-5 text-white my-5">
          <h5 className="text-2xl">Sale up to <span>30% OFF</span></h5>
          <h6 className="text-base">Free shiping on all yoor order.</h6>
        </div>
